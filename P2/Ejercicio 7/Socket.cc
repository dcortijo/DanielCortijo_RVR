...
bool operator== (const Socket &s1, const Socket &s2)
{
    ...
    return convertido1->sin_family == convertido2->sin_family && convertido1->sin_addr.s_addr == convertido2->sin_addr.s_addr && convertido1->sin_port == convertido2->sin_port;
};
